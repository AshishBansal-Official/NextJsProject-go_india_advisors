...
const FeaturedCompanies = () => {
    ...
    return (
        <div className="md:h-28">
            ...
            <div className="w-full md:bg-blue-100 h-16">
                        ...
                        return (
                            <div key={index}>
                                <Image
                                    ...
                                    height={0}
                                    sizes="100vw"
                                    className="md:max-h-10 md:min-h-[2.5rem] md:min-w-[8rem] md:max-w-[10rem] h-14 w-14 min-h-[3.5rem] min-w-[3.5rem] object-scale-down bg-white md:border-0 border-2 border-rose-600 object-center md:rounded-none rounded-full"
                                />
                            </div>
                        );
                    })}
